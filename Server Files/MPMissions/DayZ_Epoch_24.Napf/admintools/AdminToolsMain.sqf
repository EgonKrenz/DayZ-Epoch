...
if ((getPlayerUID player) in ["519170","77364870"]) then { //all admins
	...
	if ((getPlayerUID player) in ["519170","77364870"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["519170","77364870"]) then { // super admins
		adminmenu =
		[
			["",true],
...
[
	["",true],
		...
		["Generate Key", [10],  "", -5, [["expression", format[_EXECscript1,"generatekey.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
...
[
	["",true],
		...
		["Spectate Player", [8],  "", -5, [["expression", format[_EXECscript1,"spectate.sqf"]]], "1", "1"],
		["Teleport To Me", [9], "", -5, [["expression", format[_EXECscript1, "TPtoME.sqf"]]], "1", "1"],
		["Base Destruction", [10], "#USER:BaseDestructionMenu", -5, [["expression", ""]], "1", "1"],
		["Generate Key", [11],  "", -5, [["expression", format[_EXECscript1,"generatekey.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Next page", [12], "#USER:ToolsMenu2", -5, [["expression", ""]], "1", "1"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
...
["",true],
		...
		["ESCM", [3], "#USER:ECSMenu", -5, [["expression", ""]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
BaseDestructionMenu = 
...
[
	["",true],
		["SavetoDB", [2], "", -5, [["expression", '["update"] execVM "admintools\tools\ESCM.sqf"']], "1", "1"],
		["SetDmg1", [3], "", -5, [["expression", '["kill"] execVM "admintools\tools\ESCM.sqf"']], "1", "1"],
		["del01", [2], "", -5, [["expression", '["del"] execVM "admintools\tools\ESCM.sqf"']], "1", "1"],
		["del02", [3], "", -5, [["expression", '["del2"] execVM "admintools\tools\ESCM.sqf"']], "1", "1"],
		["del03", [2], "", -5, [["expression", '["del3"] execVM "admintools\tools\ESCM.sqf"']], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
